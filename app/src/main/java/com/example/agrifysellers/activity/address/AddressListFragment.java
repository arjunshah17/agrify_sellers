...
import com.example.agrifysellers.databinding.AddressListFragmentBinding;
...
public class AddressListFragment extends BottomSheetDialogFragment {
    ...
    private void initFirestore() {
        ...
        mQuery = mFirestore.collection("Sellers").document(auth.getCurrentUser().getUid()).collection("addressList");
